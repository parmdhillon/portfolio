  ...
  return (
    <>
      ...
      <div className="w-full px-5 md:px-10  flex justify-center">
        <div className="py-7 max-w-7xl">
          <h1 className="text-blue-700 font-extrabold text-3xl my-7">
            MyStall
          </h1>
          <p className="w-full my-7 lg:w-1/2 text-gray-600 font-medium leading-7 tracking-wide">
          ...
          <div className="my-7 w-full lg:w-1/2 bg-green-50 p-4 rounded-2xl">
            ...
            <div className="py-2">
              <a
                href="/"
                className="bg-blue-700 py-2 px-4 font-bold text-white rounded-lg"
              >
                View Live{' '}
          ...
          <div className="w-full flex justify-center py-7 px-3 bg-blue-100 rounded-2xl max-w-7xl">
